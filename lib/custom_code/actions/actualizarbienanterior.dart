...
Future<bool> actualizarbienanterior(
  ...
  try {
    snapshot = await firestore
        ...
        .where('numeroinventario', isEqualTo: inventarioBuscado)
        .limit(1)
        .get();
  } catch (e) {
                ...
                children: [
                  ...
                  const Text('NIVEL 1 (ORGANIZACIÓN)',
                      style: TextStyle(
                          fontWeight: FontWeight.bold, color: customGreen)),
                  Autocomplete<String>(
                    initialValue: TextEditingValue(text: nivel1Controller.text),
                  ...
                  if (confirmar) {
                    ...
                    try {
                      ...
                      final depreciacionSnap = await firestore
                          ...
                          .where('bien_ref', isEqualTo: inventarioBuscado)
                          .get();
                      ...
                      final searchUrl =
                          'https://api.servidor-inventarios.xyz/fastapi/bienesmuebles/?filter=(bien_ref%3D%22$inv%22)';
                      ...
                      if (searchResp.statusCode == 200) {
                        ...
                        if (searchData['items'] != null &&
                          ...
                          final patchResp = await http
                              .patch(
                                ...
                                body: jsonEncode({
                                  ...
                                  'depositario':
                                      depositarioController.text.trim(),
                                  'nivel1organizacion':
                                      nivel1Controller.text.trim(),
                                  'nivel2direccion':
                                      nivel2Controller.text.trim(),
                                  'nivel3jurisdiccion':
                                      nivel3Controller.text.trim(),
                                  'estatusdelbien': estatusSeleccionado,
                                  'anexo': anexoSeleccionado,
                                  'color': colorController.text.trim(),
                                  'ubicacionfisica':
                          ...
                          if (patchResp.statusCode == 200 ||
                            ...
                            final searchDepUrl =
                                'https://api.servidor-inventarios.xyz/fastapi/calculodepreciacion/?filter=(numeroinventario%3D%22$inv%22)';
