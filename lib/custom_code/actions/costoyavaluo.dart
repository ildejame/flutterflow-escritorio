...
Future<void> costoyavaluo(BuildContext context) async {
  // Color personalizado
    ...
    builder: (_) => AlertDialog(
      content: Row(
        children: [
          ...
          const SizedBox(width: 20),
          const Expanded(
              child: Text('Procesando resumen de costo y avalúo...')),
        ],
      ),
    ),
  );
  ...
  try {
    ...
    Query<Map<String, dynamic>> query =
        firestore.collection('bienesmuebles').withConverter(
    ...
    // Construcción de clases y resumen
    ...
    for (final doc in todosLosDocs) {
      ...
      final String fechaAvaluo = (data['fechaavaluo'] ?? '').toString().trim();
    ...
    // ==== NUEVO: MultiPage con header y footer (auto-paginación) ====
        ...
        child: pw.Row(
          ...
          children: [
            ...
            pw.Column(
              ...
              children: [
                pw.SizedBox(
                    height: 20), // ocupa el espacio, pero sin mostrar texto
              ],
            ),
          ],
        ),
    ...
    pdf.addPage(
      pw.MultiPage(
        ...
        build: (ctx) {
          ...
          // Filas (MultiPage las paginará automáticamente)
