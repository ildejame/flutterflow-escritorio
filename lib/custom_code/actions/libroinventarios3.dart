...
// 1. CAMBIO: Nombre de la función a libroinventarios3
Future<void> libroinventarios3(BuildContext context) async {
          ...
          build: (context) {
            return pw.Column(
              ...
              children: [
                ...
                pw.Table(
                  border: pw.TableBorder.all(width: 0.5),
                  // CAMBIO: Ajuste de anchos para 7 columnas
                  columnWidths: {
                    0: pw.FlexColumnWidth(1.2), // Partida
                    1: pw.FlexColumnWidth(1.5), // ID
                    2: pw.FlexColumnWidth(
                        3.3), // Descripcion (reducido para espacio)
                    3: pw.FlexColumnWidth(0.8), // Cantidad
                    4: pw.FlexColumnWidth(1.5), // NUEVA: Costo Unitario
                    5: pw.FlexColumnWidth(1.2), // Unidad
                    6: pw.FlexColumnWidth(2.0), // MONTO
                  },
                  children: [
                    pw.TableRow(
                        ...
                        pw.Padding(
                            ...
                            child: pw.Center(
                                child: pw.Text('CANTIDAD',
                                    style: tableHeaderStyle))),
                        // CAMBIO: Nueva columna encabezado
                        pw.Padding(
                            padding: pw.EdgeInsets.all(3),
                            child: pw.Center(
                    ...
                    ...subsetBienes.map((doc) {
                      ...
                      return pw.TableRow(
                        children: [
                          ...
                          // CAMBIO: Nueva celda con Costo Unitario (mismo valor)
                          pw.Padding(
                              padding: pw.EdgeInsets.all(3),
                              child: pw.Align(
                                  alignment: pw.Alignment.centerRight,
                          ...
                          pw.Padding(
                              ...
                              child: pw.Center(
                                  child: pw.Text(
                                      ...
                                      style: totalStyle))),
                          // CAMBIO: Celda vacía extra para alinear Costo Unitario
                          pw.Padding(
                              padding: pw.EdgeInsets.all(3),
                              child: pw.Text('', style: totalStyle)),
                          pw.Padding(
