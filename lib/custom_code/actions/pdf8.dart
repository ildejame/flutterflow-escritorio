...
Future<void> pdf8(
  ...
  // CRUCIAL: Asignar la lista a una variable local no nula
  ...
  // Función para construir la sección de firmas y leyenda
  pw.Widget _buildSignatureSection(String depositario, String cargoDepositario,
      String revisor, String cargoRevisor) {
    // Usamos Container con margen para crear el espacio entre la tabla y las firmas
    return pw.Container(
  ...
  // Función para construir el encabezado con logo y título
      ...
      children: [
        ...
        pw.Column(
          ...
          children: [
            ...
            pw.Text(
              "ANEXO 5. RESGUARDO DE BIENES MUEBLES",
              style: headerTextStyle,
              textAlign: pw.TextAlign.center,
            ),
            pw.Text(
  ...
  // Define la fila de encabezados de la tabla
  ...
  // --- GENERACIÓN DE PÁGINAS CON MultiPage para gestión inteligente de espacio ---
  pdf.addPage(
    pw.MultiPage(
      ...
      header: (pw.Context context) {
        // El encabezado principal se repite en todas las páginas
        return pw.Column(
          children: [
            _buildMainHeader(),
            pw.SizedBox(height: 10),
            ...
            pw.Table(
              // Este TableBorder está bien con `const pw.TableBorder()`
      ...
      build: (pw.Context context) {
        ...
        // 1. Tabla de bienes muebles (filas de datos)
        widgets.add(
          pw.Table(
            border: const pw.TableBorder(
                // 🛑 MODIFICACIÓN: Ninguna línea divisoria interna
                horizontalInside: pw.BorderSide.none,
                verticalInside: pw.BorderSide.none,
                top: pw.BorderSide.none,
                bottom: const pw.BorderSide()), // Solo borde inferior
            columnWidths: const {
        ...
        // 2. Fila de totales (al final de los datos de la tabla)
        if (listaBienes.isNotEmpty) {
          widgets.add(pw.Table(
            // Mantiene los bordes de la caja de totales
            border: const pw.TableBorder(
                left: const pw.BorderSide(),
                right: const pw.BorderSide(),
                bottom: const pw.BorderSide()),
              ...
              pw.TableRow(
                ...
                children: [
                  ...
                  pw.Container(
                    ...
                    child: pw.Text("Total depto.: ", style: totalRowStyle),
                  ),
        ...
        // 3. Sección de firmas
        widgets.add(_buildSignatureSection(texto1, texto2, texto3, texto4));
