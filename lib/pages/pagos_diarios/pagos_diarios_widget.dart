...
import 'pagos_diarios_model.dart';
export 'pagos_diarios_model.dart';

class PagosDiariosWidget extends StatefulWidget {
  const PagosDiariosWidget({super.key});

  static String routeName = 'PagosDiarios';
  static String routePath = 'pagosDiarios';

  @override
  State<PagosDiariosWidget> createState() => _PagosDiariosWidgetState();
}

class _PagosDiariosWidgetState extends State<PagosDiariosWidget> {
  late PagosDiariosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PagosDiariosModel());
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              Text(
                                FFLocalizations.of(context).getText(
                                  'ou3knr6w' /* Pendiente de Pagar Hoy */,
                                ),
                                textAlign: TextAlign.center,
