...
import 'pendientes_anual_copy_model.dart';
export 'pendientes_anual_copy_model.dart';

class PendientesAnualCopyWidget extends StatefulWidget {
  const PendientesAnualCopyWidget({super.key});

  static String routeName = 'PendientesAnualCopy';
  static String routePath = 'pendientesAnualCopy';

  @override
  State<PendientesAnualCopyWidget> createState() =>
      _PendientesAnualCopyWidgetState();
}

class _PendientesAnualCopyWidgetState extends State<PendientesAnualCopyWidget> {
  late PendientesAnualCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PendientesAnualCopyModel());
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              Text(
                                FFLocalizations.of(context).getText(
                                  '2qpi7gsy' /* Pendiente de Pagar Anual */,
                                ),
                                textAlign: TextAlign.center,
                                ...
                                return SingleChildScrollView(
                                  child: Column(
                                    ...
                                    children: List.generate(
                                        columnEstablecimientosRecordList.length,
                                        (columnIndex) {
                                                                        ...
                                                                        Padding(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            valueOrDefault<String>(
                                                                              dateTimeFormat(
                                                                                "yMd",
                                                                                columnEstablecimientosRecord.fechadeUltimoPago,
                                                            ...
                                                            child: StreamBuilder<
                                                              ...
                                                              builder: (context,
                                                                ...
                                                                List<FoliosPDFsAltasRecord>
                                                                    ...
                                                                    snapshot
                                                                        .data!;
                                                                final textFoliosPDFsAltasRecord =
                                                                    textFoliosPDFsAltasRecordList
                                                                            .isNotEmpty
                                                                        ? textFoliosPDFsAltasRecordList
                                                                            .first
