...
import 'precio_m2_model.dart';
export 'precio_m2_model.dart';

class PrecioM2Widget extends StatefulWidget {
  const PrecioM2Widget({
    super.key,
    this.usersParam,
  });
  ...
  static String routeName = 'PrecioM2';
  static String routePath = 'precioM2';

  @override
  State<PrecioM2Widget> createState() => _PrecioM2WidgetState();
}

class _PrecioM2WidgetState extends State<PrecioM2Widget> {
  late PrecioM2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PrecioM2Model());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<UsersRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final precioM2UsersRecord = snapshot.data!;
                                  ...
                                  child: Padding(
                                    ...
                                    child: TextFormField(
                                      controller:
                                        ...
                                        text: precioM2UsersRecord.displayName,
                                      ),
                                      ...
                                      decoration: InputDecoration(
                                        labelText:
                                            FFLocalizations.of(context).getText(
                                          'i6jgxmbk' /* Nombre Oficial */,
                                        ),
                                        hintText:
                                            FFLocalizations.of(context).getText(
                                          's0vlgxfv' /* Nombre completo Oficial */,
                                        ),
                                        ...
                                        suffixIcon: _model.nombreTextController!
                                                .text.isNotEmpty
                                            ? InkWell(
                                                onTap: () async {
                                                  _model.nombreTextController
                                    ...
                                    child: TextFormField(
                                      controller:
                                          _model.telefonoTextController ??=
                                              TextEditingController(
                                        text: precioM2UsersRecord.phoneNumber,
                                      ),
                                  ...
                                  child: TextFormField(
                                    controller:
                                        _model.whatsAppTextController ??=
                                            TextEditingController(
                                      text: precioM2UsersRecord.wathsApp
                                          .toString(),
                                    ),
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      suffixIcon: _model.whatsAppTextController!
                                              .text.isNotEmpty
                                          ? InkWell(
                                              onTap: () async {
                                                _model.whatsAppTextController
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  Text(
                                    FFLocalizations.of(context).getText(
                                      'cyp27ioj' /* Firma del Oficial de Comercio */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                      ...
                                      Padding(
                                        ...
                                        child: FFButtonWidget(
                                          onPressed: () async {
                                            ...
                                            await precioM2UsersRecord.reference
