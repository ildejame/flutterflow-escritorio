...
class VerComentariosWidget extends StatefulWidget {
  ...
  static String routeName = 'VerComentarios';
  static String routePath = 'verComentarios';
        ...
        appBar: AppBar(
          ...
          title: Text(
            FFLocalizations.of(context).getText(
              'ovvp40m5' /* Comentarios por comercio */,
            ),
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                Padding(
                  padding:
                      EdgeInsetsDirectional.fromSTEB(200.0, 5.0, 200.0, 0.0),
                  child: StreamBuilder<List<ComentariosComerciosRecord>>(
                    stream: queryComentariosComerciosRecord(
                      parent: widget.comercioParam,
                      queryBuilder: (comentariosComerciosRecord) =>
                          comentariosComerciosRecord.orderBy('fecha',
                              descending: true),
                    ),
                    builder: (context, snapshot) {
                      ...
                      List<ComentariosComerciosRecord>
                          listViewComentariosComerciosRecordList =
                          snapshot.data!;
                      ...
                      return ListView.builder(
                        ...
                        itemCount:
                            listViewComentariosComerciosRecordList.length,
                        itemBuilder: (context, listViewIndex) {
                          final listViewComentariosComerciosRecord =
                              listViewComentariosComerciosRecordList[
                                  listViewIndex];
                          return Padding(
                                          ...
                                          onTap: () async {
                                            await launchURL(
                                              ...
                                              functions.getURLImage(
                                                  listViewComentariosComerciosRecord
                                                      .imagen),
                                      ...
                                      children: [
                                        InkWell(
                                          ...
                                          onTap: () async {
                                            ...
                                            await listViewComentariosComerciosRecord
                                                .reference
                                                .delete();
                                          },
                                          child: Text(
                                            FFLocalizations.of(context).getText(
                                              '9kngww9o' /* ELIMINAR REPORTE */,
                                            ),
