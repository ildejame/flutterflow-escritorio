...
class VerComercioModel extends FlutterFlowModel<VerComercioWidget> {
  ...
  FocusNode? giroFocusNode;
  TextEditingController? giroTextController;
  String? Function(BuildContext, String?)? giroTextControllerValidator;
  // State field(s) for Movimiento widget.
  FocusNode? movimientoFocusNode;
  TextEditingController? movimientoTextController;
  String? Function(BuildContext, String?)? movimientoTextControllerValidator;
  // State field(s) for PagoAdicional widget.
  FocusNode? pagoAdicionalFocusNode;
  TextEditingController? pagoAdicionalTextController;
  String? Function(BuildContext, String?)? pagoAdicionalTextControllerValidator;
  // State field(s) for UltimoPagoAnual widget.
  FocusNode? ultimoPagoAnualFocusNode1;
  TextEditingController? ultimoPagoAnualTextController1;
  String? Function(BuildContext, String?)?
      ultimoPagoAnualTextController1Validator;
  // State field(s) for UltimoPagoAnual widget.
  FocusNode? ultimoPagoAnualFocusNode2;
  TextEditingController? ultimoPagoAnualTextController2;
  String? Function(BuildContext, String?)?
      ultimoPagoAnualTextController2Validator;
  ...
  void dispose() {
    ...
    giroFocusNode?.dispose();
    giroTextController?.dispose();

    movimientoFocusNode?.dispose();
    movimientoTextController?.dispose();

    pagoAdicionalFocusNode?.dispose();
    pagoAdicionalTextController?.dispose();

    ultimoPagoAnualFocusNode1?.dispose();
    ultimoPagoAnualTextController1?.dispose();

    ultimoPagoAnualFocusNode2?.dispose();
    ultimoPagoAnualTextController2?.dispose();
