...
class VerComercioWidget extends StatefulWidget {
  ...
  static String routeName = 'VerComercio';
  static String routePath = 'verComercio';
...
class _VerComercioWidgetState extends State<VerComercioWidget> {
  ...
  void initState() {
    ...
    _model.giroFocusNode ??= FocusNode();

    _model.movimientoFocusNode ??= FocusNode();

    _model.pagoAdicionalFocusNode ??= FocusNode();

    _model.ultimoPagoAnualFocusNode1 ??= FocusNode();

    _model.ultimoPagoAnualFocusNode2 ??= FocusNode();
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<EstablecimientosRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final verComercioEstablecimientosRecord = snapshot.data!;
            ...
            appBar: AppBar(
              ...
              title: Text(
                FFLocalizations.of(context).getText(
                  'ecppvadx' /* Datos del Establecimiento */,
                ),
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        BarcodeWidget(
                                          data:
                                              verComercioEstablecimientosRecord
                                                  .codigoQR,
                                            ...
                                            child: TextFormField(
                                              ...
                                              decoration: InputDecoration(
                                                labelText:
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                  '6umuw19e' /* Nombre Propietario */,
                                                ),
                                                hintText:
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                  'wirmp8kt' /* Nombre completo propietario */,
                                                ),
                                                enabledBorder:
                                                    OutlineInputBorder(
                                                  borderSide: BorderSide(
                                          ...
                                          child: TextFormField(
                                            ...
                                            decoration: InputDecoration(
                                              labelText:
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                'r2ad4r51' /* Domicilio Particular */,
                                              ),
                                              hintText:
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                '5d1zf706' /* Dirección del propietario */,
                                              ),
                                          ...
                                          child: TextFormField(
                                            ...
                                            decoration: InputDecoration(
                                              labelText:
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                'obcdj4hc' /* Persona Física o Moral */,
                                              ),
                                              hintText:
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                'ocid9v7i' /* Persona Física o Moral */,
                                              ),
                                              enabledBorder: OutlineInputBorder(
                                                borderSide: BorderSide(
                                                  color: Color(0xFF621132),
                                          ...
                                          child: TextFormField(
                                            ...
                                            decoration: InputDecoration(
                                              labelText:
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                'ukzzzsbj' /* Nacionalidad Propietario */,
                                              ),
                                              hintText:
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                'p6mikrct' /* Nacionalidad */,
                                              ),
                                              enabledBorder: OutlineInputBorder(
                                                borderSide: BorderSide(
                                                  color: Color(0xFF621132),
                                          ...
                                          child: TextFormField(
                                            ...
                                            decoration: InputDecoration(
                                              labelText:
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                'brh3ky32' /* Nombre del Establecimiento */,
                                              ),
                                              hintText:
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                '8r2carl5' /* Nombre del Establecimiento */,
                                              ),
                                              enabledBorder: OutlineInputBorder(
                                                borderSide: BorderSide(
                                                  color: Color(0xFF621132),
                                          ...
                                          child: TextFormField(
                                            ...
                                            decoration: InputDecoration(
                                              labelText:
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                '7fq7oo4u' /* Domicilio Negocio */,
                                              ),
                                              hintText:
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                '6rau2fmp' /* Dirección del Negocio */,
                                              ),
                                              enabledBorder: OutlineInputBorder(
                                                borderSide: BorderSide(
                                                  color: Color(0xFF621132),
                                          ...
                                          child: TextFormField(
                                            ...
                                            decoration: InputDecoration(
                                              labelText:
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                'gvhmqnr1' /* Colonia Negocio */,
                                              ),
                                              hintText:
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                'ugpvueyu' /* Colonia del Negocio */,
                                              ),
                                              enabledBorder: OutlineInputBorder(
                                                borderSide: BorderSide(
                                                  color: Color(0xFF621132),
                                          ...
                                          child: TextFormField(
                                            ...
                                            decoration: InputDecoration(
                                              labelText:
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                'q0qagga7' /* Número Negocio */,
                                              ),
                                              hintText:
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                '9wsv5dig' /* Número del Negocio */,
                                              ),
                                              enabledBorder: OutlineInputBorder(
                                                borderSide: BorderSide(
                                                  color: Color(0xFF621132),
                                            ...
                                            Expanded(
                                              child: Padding(
                                                ...
                                                child: TextFormField(
                                                  ...
                                                  focusNode:
                                                      _model.giroFocusNode,
                                                  onChanged: (_) =>
                                                      EasyDebounce.debounce(
                                                    '_model.giroTextController',
                                                    Duration(
                                                        milliseconds: 2000),
                                                    () => safeSetState(() {}),
                                                  ),
                                            ...
                                            Expanded(
                                              child: Padding(
                                                ...
                                                child: TextFormField(
                                                  ...
                                                  onChanged: (_) =>
                                                      EasyDebounce.debounce(
                                                    '_model.movimientoTextController',
                                                    Duration(
                                                        milliseconds: 2000),
                                                    () => safeSetState(() {}),
                                                  ),
                                                  ...
                                                  keyboardType:
                                                      TextInputType.multiline,
                                                  validator: _model
                                                      .movimientoTextControllerValidator
                                                      .asValidator(context),
                                                ),
                                              ),
                                            ),
                                            Expanded(
                                              child: Padding(
                                                ...
                                                child: TextFormField(
                                                  ...
                                                  focusNode: _model
                                                      .pagoAdicionalFocusNode,
                                                  onChanged: (_) =>
                                                      EasyDebounce.debounce(
                                                    '_model.pagoAdicionalTextController',
                                                    Duration(
                                                        milliseconds: 2000),
                                                    () => safeSetState(() {}),
                                                  ),
                                                  ...
                                                  decoration: InputDecoration(
                                                    labelText:
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                      'xd826rdr' /* PagoAdicional */,
                                                    ),
                                                    hintText:
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                      's83ak5nu' /* Pago Adicional */,
                                                    ),
                                                    enabledBorder:
                                                        OutlineInputBorder(
                                                      borderSide: BorderSide(
                                                  ...
                                                  keyboardType:
                                                      TextInputType.multiline,
                                                  validator: _model
                                                      .pagoAdicionalTextControllerValidator
                                                      .asValidator(context),
                                                ),
                                              ),
                                            ),
                                    ...
                                    children: [
                                      Expanded(
                                        child: Padding(
                                          ...
                                          child: TextFormField(
                                            controller: _model
                                                    .ultimoPagoAnualTextController1 ??=
                                                TextEditingController(
                                              text: dateTimeFormat(
                                                "d/M/y",
                                                verComercioEstablecimientosRecord
                                            ...
                                            focusNode: _model
                                                .ultimoPagoAnualFocusNode1,
                                            onChanged: (_) =>
                                                EasyDebounce.debounce(
                                              '_model.ultimoPagoAnualTextController1',
                                              Duration(milliseconds: 2000),
                                              () => safeSetState(() {}),
                                            ),
                                            autofocus: true,
                                            ...
                                            decoration: InputDecoration(
                                              labelText:
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                '4ddafsb0' /* Ultimo Pago Anual */,
                                              ),
                                              hintText:
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                'a01bcuto' /* Ultimo Pago Anual */,
                                              ),
                                              enabledBorder: OutlineInputBorder(
                                                borderSide: BorderSide(
                                                  color: Color(0xFF621132),
                                    ...
                                    children: [
                                      Expanded(
                                        child: Padding(
                                          ...
                                          child: TextFormField(
                                            controller: _model
                                                    .ultimoPagoAnualTextController2 ??=
                                                TextEditingController(
                                              text:
                                                  verComercioEstablecimientosRecord
                                            ...
                                            focusNode: _model
                                                .ultimoPagoAnualFocusNode2,
                                            onChanged: (_) =>
                                                EasyDebounce.debounce(
                                              '_model.ultimoPagoAnualTextController2',
                                              Duration(milliseconds: 2000),
                                              () => safeSetState(() {}),
                                            ),
                                            autofocus: true,
                                            ...
                                            decoration: InputDecoration(
                                              labelText:
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                'r3w0nwde' /* Ultimo Pago Diario */,
                                              ),
                                              hintText:
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                'm8pzizf5' /* Ultimo Pago Diario */,
                                              ),
                                              enabledBorder: OutlineInputBorder(
                                                borderSide: BorderSide(
                                                  color: Color(0xFF621132),
                                          ...
                                          child: TextFormField(
                                            ...
                                            decoration: InputDecoration(
                                              labelText:
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                'dtjbx8yh' /* Superficie M2 */,
                                              ),
                                              hintText:
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                'm9lap03f' /* Superficie en M2 */,
                                              ),
                                              enabledBorder: OutlineInputBorder(
                                                borderSide: BorderSide(
                                                  color: Color(0xFF621132),
                                        ...
                                        child: Padding(
                                          ...
                                          child: TextFormField(
                                            controller: _model
                                                ...
                                                TextEditingController(
                                              text: verComercioEstablecimientosRecord
                                            ...
                                            decoration: InputDecoration(
                                              labelText:
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                'cu3urpx7' /* Descripción Actividad Comercia... */,
                                              ),
                                              hintText:
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                'wwls2yhm' /* Descripción Actividad Comercia... */,
                                              ),
                                              enabledBorder: OutlineInputBorder(
                                                borderSide: BorderSide(
                                                  color: Color(0xFF621132),
                                          ...
                                          child: TextFormField(
                                            ...
                                            decoration: InputDecoration(
                                              labelText:
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                '3085snel' /* Fecha Inicio Operaciones */,
                                              ),
                                              hintText:
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                'kyd4ximh' /* Fecha Inicio Operaciones */,
                                              ),
                                              enabledBorder: OutlineInputBorder(
                                                borderSide: BorderSide(
                                                  color: Color(0xFF621132),
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Text(
                                          FFLocalizations.of(context).getText(
                                            'js74qfpn' /* Elegir fotos complementarias */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          Text(
                                            FFLocalizations.of(context).getText(
                                              'pfw5ijkh' /* Firma Personal Comercio */,
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          Text(
                                            FFLocalizations.of(context).getText(
                                              '9rkhn0rf' /* Firma Dueño o encargado */,
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
