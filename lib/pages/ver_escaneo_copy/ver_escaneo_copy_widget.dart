...
import 'ver_escaneo_copy_model.dart';
export 'ver_escaneo_copy_model.dart';

class VerEscaneoCopyWidget extends StatefulWidget {
  const VerEscaneoCopyWidget({
    super.key,
    this.comercioParam,
  });
  ...
  static String routeName = 'VerEscaneoCopy';
  static String routePath = 'verEscaneoCopy';

  @override
  State<VerEscaneoCopyWidget> createState() => _VerEscaneoCopyWidgetState();
}

class _VerEscaneoCopyWidgetState extends State<VerEscaneoCopyWidget>
    with TickerProviderStateMixin {
  late VerEscaneoCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VerEscaneoCopyModel());
        ...
        appBar: AppBar(
          ...
          title: Text(
            FFLocalizations.of(context).getText(
              'jslf6aup' /* Ver documento escaneado */,
            ),
