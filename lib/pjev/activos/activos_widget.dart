...
import 'activos_model.dart';
export 'activos_model.dart';

class ActivosWidget extends StatefulWidget {
  const ActivosWidget({super.key});

  static String routeName = 'Activos';
  static String routePath = 'activos';

  @override
  State<ActivosWidget> createState() => _ActivosWidgetState();
}

class _ActivosWidgetState extends State<ActivosWidget> {
  late ActivosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ActivosModel());
                                      ...
                                      children: [
                                        Expanded(
                                          child: FFButtonWidget(
                                            onPressed: () async {
                                              await actions
                                                  .depreciacionOficinas(
                                                context,
                                              );
                                            },
                                            text: FFLocalizations.of(context)
                                                .getText(
                                              'orygccqm' /* Imn. valuados */,
                                            ),
                                            icon: Icon(
                                              Icons.view_list,
                                              size: 24.0,
                                                            ...
                                                            children: [
                                                              InkWell(
                                                                ...
                                                                onTap:
                                                                    () async {
                                                                  await actions
                                                                      .generarFormularioYPdfInventario(
                                                                    context,
                                                                    currentJwtToken,
                                                                    valueOrDefault<
                                                                        String>(
