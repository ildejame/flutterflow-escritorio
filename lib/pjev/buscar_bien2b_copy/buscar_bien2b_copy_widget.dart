...
import 'buscar_bien2b_copy_model.dart';
export 'buscar_bien2b_copy_model.dart';

class BuscarBien2bCopyWidget extends StatefulWidget {
  const BuscarBien2bCopyWidget({
    super.key,
    required this.datosMueble,
  });

  final dynamic datosMueble;

  @override
  State<BuscarBien2bCopyWidget> createState() => _BuscarBien2bCopyWidgetState();
}

class _BuscarBien2bCopyWidgetState extends State<BuscarBien2bCopyWidget> {
  late BuscarBien2bCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BuscarBien2bCopyModel());
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      10.0, 10.0, 10.0, 0.0),
                                  child: StreamBuilder<List<ListasPJEVRecord>>(
                                    stream: queryListasPJEVRecord(
                                      queryBuilder: (listasPJEVRecord) =>
                                        ...
                                        child: Autocomplete<String>(
                                          ...
                                          optionsViewBuilder:
                                            ...
                                            return AutocompleteOptionsList(
                                              textFieldKey: _model.articuloKey,
                                              ...
                                              decoration: InputDecoration(
                                                labelText:
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                  'kxi5vpvw' /* Nombre artículo */,
                                                ),
                                                hintText:
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                  '6qhypre6' /* Nombre artículo */,
                                                ),
                                                enabledBorder:
                                                    OutlineInputBorder(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Container(
                                    ...
                                    child: TextFormField(
                                      ...
                                      focusNode:
                                          _model.numeroinventarioidFocusNode,
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      '15sxlk0v' /* Número de ID del bien */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                ...
                                Padding(
                                  ...
                                  child: Container(
                                    ...
                                    child: TextFormField(
                                      ...
                                      focusNode: _model.iDanteriorFocusNode,
                                      onChanged: (_) => EasyDebounce.debounce(
                                        '_model.iDanteriorTextController',
                                        Duration(milliseconds: 2000),
                                        () => safeSetState(() {}),
                                      ...
                                      decoration: InputDecoration(
                                        labelText:
                                            FFLocalizations.of(context).getText(
                                          'x2xqitz1' /* ID anterior */,
                                        ),
                                        hintText:
                                            FFLocalizations.of(context).getText(
                                          '5w1vuwy6' /* Número de ID anterior */,
                                        ),
                                        enabledBorder: OutlineInputBorder(
                                          borderSide: BorderSide(
                                            color: FlutterFlowTheme.of(context)
                                ...
                                Padding(
                                  ...
                                  child: Container(
                                    width:
                                        MediaQuery.sizeOf(context).width * 0.3,
                                    child: TextFormField(
                                      controller: _model.importeTextController,
                                      focusNode: _model.importeFocusNode,
                                      onChanged: (_) => EasyDebounce.debounce(
                                      ...
                                      decoration: InputDecoration(
                                        labelText:
                                            FFLocalizations.of(context).getText(
                                          'q2x9yxdx' /* Costo del bien ($) contra fact... */,
                                        ),
                                        hintText:
                                            FFLocalizations.of(context).getText(
                                          'hozsd8hc' /* Costo del bien ($) contra fact... */,
                                        ),
                                        enabledBorder: OutlineInputBorder(
                                          borderSide: BorderSide(
                                            color: Color(0xFF95A1AC),
                              ...
                              child: Column(
                                ...
                                children: [
                                    ...
                                    child: Container(
                                      ...
                                      child: Autocomplete<String>(
                                        ...
                                        optionsViewBuilder:
                                            (context, onSelected, options) {
                                          return AutocompleteOptionsList(
                                            textFieldKey: _model.titularKey,
                                            textController:
                                          ...
                                          return TextFormField(
                                            ...
                                            decoration: InputDecoration(
                                              labelText:
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                'nu2et1v4' /* Depositario del bien */,
                                              ),
                                              hintText:
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                '2jnzoiif' /* Nombre del depositario */,
                                              ),
                                              enabledBorder: OutlineInputBorder(
                                                borderSide: BorderSide(
                                                  color: Color(0xFF95A1AC),
                                  ...
                                  Padding(
                                    ...
                                    child: Text(
                                      FFLocalizations.of(context).getText(
                                        'ypmz8uiu' /* Nombre del depositario, quien ... */,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Container(
                                      ...
                                      child: TextFormField(
                                        ...
                                        focusNode: _model.depositarioFocusNode,
                                        onChanged: (_) => EasyDebounce.debounce(
                                          '_model.depositarioTextController',
                                          Duration(milliseconds: 2000),
                                          () => safeSetState(() {}),
                                        ...
                                        decoration: InputDecoration(
                                          ...
                                          hintText: FFLocalizations.of(context)
                                              .getText(
                                            'ir5vv0fu' /* Nombre de depositario */,
                                          ),
                                          enabledBorder: OutlineInputBorder(
                                            borderSide: BorderSide(
                                              color: Color(0xFF95A1AC),
                                  ...
                                  Padding(
                                    ...
                                    child: Text(
                                      FFLocalizations.of(context).getText(
                                        'nf97t067' /* Nombre del usuario del Bien */,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                ...
                                fieldViewBuilder: (
                                  ...
                                  return TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      labelText:
                                          FFLocalizations.of(context).getText(
                                        'phis982q' /* ORGANIZACIÓN */,
                                      ),
                                      hintText:
                                          FFLocalizations.of(context).getText(
                                        't83g665x' /* teclear para autocompletar */,
                                      ),
                                ...
                                fieldViewBuilder: (
                                  ...
                                  return TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      labelText:
                                          FFLocalizations.of(context).getText(
                                        '5s1jfvo3' /* Ingresar nombre nivel 2. DIREC... */,
                                      ),
                                      hintText:
                                          FFLocalizations.of(context).getText(
                                        'gq8pilt2' /* teclear para autocompletar */,
                                      ),
                                      hintStyle: FlutterFlowTheme.of(context)
                                          .bodySmall
                                          .override(
                                ...
                                fieldViewBuilder: (
                                  ...
                                  return TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      labelText:
                                          FFLocalizations.of(context).getText(
                                        'umb7r8wt' /* Ingresar nombre nivel 3. JURIS... */,
                                      ),
                                      hintText:
                                          FFLocalizations.of(context).getText(
                                        '1ooh67kr' /* teclear para autocompletar */,
                                      ),
                                      hintStyle: FlutterFlowTheme.of(context)
                                          .bodySmall
                                          .override(
