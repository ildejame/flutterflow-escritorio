...
import '/index.dart';
import 'crear_bien_widget.dart' show CrearBienWidget;
import 'package:flutter/material.dart';

class CrearBienModel extends FlutterFlowModel<CrearBienWidget> {
  ///  State fields for stateful widgets in this page.

  // Stores action output result for [Custom Action - obtenerNombresEmpleados] action in CrearBien widget.
  List<String>? resultadoNombres;
  // Stores action output result for [Custom Action - obtenerOficinas] action in CrearBien widget.
  ...
  bool isDataUploading_uploadData45Zkm = false;
  FFUploadedFile uploadedLocalFile_uploadData45Zkm =
      FFUploadedFile(bytes: Uint8List.fromList([]), originalFilename: '');
  String uploadedFileUrl_uploadData45Zkm = '';
