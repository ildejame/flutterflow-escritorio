...
class _ExcelWidgetState extends State<ExcelWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ExcelModel());
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              labelText: FFLocalizations.of(context).getText(
                                'gmwxpvyn' /* Ingresar el ID del bien */,
                              ),
                              hintText: FFLocalizations.of(context).getText(
                                '5xmv9w0a' /* Número de inventario del bien */,
                              ),
                          ...
                          child: StreamBuilder<List<BienesmueblesRecord>>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              return FFButtonWidget(
                                onPressed: () async {
                                  await actions.bajarlista(
                                    context,
                                    buttonBienesmueblesRecordList.toList(),
                                  );
                                },
                                text: FFLocalizations.of(context).getText(
                                  '958kkhk1' /* Buscar bien */,
                                ),
