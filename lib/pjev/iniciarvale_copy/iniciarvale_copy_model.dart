...
import '/index.dart';
import 'iniciarvale_copy_widget.dart' show IniciarvaleCopyWidget;
import 'package:flutter/material.dart';

class IniciarvaleCopyModel extends FlutterFlowModel<IniciarvaleCopyWidget> {
  ///  State fields for stateful widgets in this page.

  // Stores action output result for [Custom Action - obtenerNombresEmpleados] action in IniciarvaleCopy widget.
  List<String>? resultadoNombres;
  // Stores action output result for [Custom Action - obtenerOficinas] action in IniciarvaleCopy widget.
  ...
  // Stores action output result for [Custom Action - validarFormularioMovimiento] action in Button widget.
  bool? confirmar04;
