...
export 'mantenimiento_model.dart';

class MantenimientoWidget extends StatefulWidget {
  const MantenimientoWidget({super.key});

  @override
  State<MantenimientoWidget> createState() => _MantenimientoWidgetState();
}
...
class _MantenimientoWidgetState extends State<MantenimientoWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MantenimientoModel());
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              labelText: FFLocalizations.of(context).getText(
                                'bts6z9e2' /* Ingresar el ID del bien */,
                              ),
                              hintText: FFLocalizations.of(context).getText(
                                'w9smqji9' /* Número de inventario del bien */,
                              ),
                        ...
                        child: Container(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              ...
                              context
                                  .pushNamed(MantenimientoValeWidget.routeName);
                            },
                            text: FFLocalizations.of(context).getText(
                              'uaepnv23' /* Buscar bien */,
                            ),
