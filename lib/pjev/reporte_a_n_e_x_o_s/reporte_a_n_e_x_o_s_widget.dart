...
import '/pjev/reporte_a_n_e_x_o_sb/reporte_a_n_e_x_o_sb_widget.dart';
import 'package:easy_debounce/easy_debounce.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:provider/provider.dart';
import 'reporte_a_n_e_x_o_s_model.dart';
export 'reporte_a_n_e_x_o_s_model.dart';

class ReporteANEXOSWidget extends StatefulWidget {
  const ReporteANEXOSWidget({super.key});

  @override
  State<ReporteANEXOSWidget> createState() => _ReporteANEXOSWidgetState();
}

class _ReporteANEXOSWidgetState extends State<ReporteANEXOSWidget> {
  late ReporteANEXOSModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReporteANEXOSModel());
                      ...
                      Flexible(
                        child: Text(
                          valueOrDefault<String>(
                            ...
                            'Ingresar todos los campos para generar el PDF del anexo correspondiente',
                          ),
                              ...
                              return TextFormField(
                                ...
                                decoration: InputDecoration(
                                  labelText:
                                    ...
                                    'spiqxiz2' /* Ingresar nombre nivel 1. ORGAN... */,
                                  ),
                                  hintText: FFLocalizations.of(context).getText(
                                    'a93rdl76' /* teclear para autocompletar */,
                                  ),
                            ...
                            fieldViewBuilder: (
                              ...
                              return TextFormField(
                                ...
                                decoration: InputDecoration(
                                  labelText:
                                      FFLocalizations.of(context).getText(
                                    '6fc45be1' /* Ingresar nombre nivel 2. DIREC... */,
                                  ),
                                  hintText: FFLocalizations.of(context).getText(
                                    'kmsfxj8n' /* teclear para autocompletar */,
                                  ),
                                  hintStyle: FlutterFlowTheme.of(context)
                                      .bodySmall
                                      .override(
                            ...
                            fieldViewBuilder: (
                              ...
                              return TextFormField(
                                ...
                                decoration: InputDecoration(
                                  labelText:
                                      FFLocalizations.of(context).getText(
                                    'uu5nsh6q' /* Ingresar nombre nivel 3. JURIS... */,
                                  ),
                                  hintText: FFLocalizations.of(context).getText(
                                    '63fot9q6' /* teclear para autocompletar */,
                                  ),
                                  hintStyle: FlutterFlowTheme.of(context)
                                      .bodySmall
                                      .override(
