...
import 'reporte_ubicacion2_model.dart';
export 'reporte_ubicacion2_model.dart';

class ReporteUbicacion2Widget extends StatefulWidget {
  const ReporteUbicacion2Widget({super.key});

  @override
  State<ReporteUbicacion2Widget> createState() =>
      _ReporteUbicacion2WidgetState();
}

class _ReporteUbicacion2WidgetState extends State<ReporteUbicacion2Widget> {
  late ReporteUbicacion2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReporteUbicacion2Model());
                    ...
                    children: [
                      Text(
                        FFLocalizations.of(context).getText(
                          '3okahk08' /* Ingresar todos los datos
para ... */
                          ,
                        ),
                            ...
                            fieldViewBuilder: (
                              ...
                              return TextFormField(
                                ...
                                decoration: InputDecoration(
                                  labelText:
                                      FFLocalizations.of(context).getText(
                                    '30ulqggz' /* Depositario */,
                                  ),
                                  hintText: FFLocalizations.of(context).getText(
                                    'nmu28tpb' /* Depositario */,
                                  ),
                            ...
                            fieldViewBuilder: (
                              ...
                              return TextFormField(
                                ...
                                decoration: InputDecoration(
                                  labelText:
                                      FFLocalizations.of(context).getText(
                                    '9i8khrfd' /* Supervisor de Control de Inven... */,
                                  ),
                                  hintText: FFLocalizations.of(context).getText(
                                    'ip5pepdi' /* Supervisor del área de Control... */,
                                  ),
                                  hintStyle: FlutterFlowTheme.of(context)
                                      .bodySmall
                                      .override(
                            ...
                            fieldViewBuilder: (
                              ...
                              return TextFormField(
                                ...
                                decoration: InputDecoration(
                                  labelText:
                                      FFLocalizations.of(context).getText(
                                    'aa4yl05m' /* ORGANIZACIÓN */,
                                  ),
                                  hintText: FFLocalizations.of(context).getText(
                                    '60rzlbte' /* teclear para autocompletar */,
                                  ),
                                  hintStyle: FlutterFlowTheme.of(context)
                                      .bodySmall
                                      .override(
                            ...
                            fieldViewBuilder: (
                              ...
                              return TextFormField(
                                ...
                                decoration: InputDecoration(
                                  labelText:
                                      FFLocalizations.of(context).getText(
                                    'zybc6x1x' /* Ingresar nombre nivel 2. DIREC... */,
                                  ),
                                  hintText: FFLocalizations.of(context).getText(
                                    '5y4nwyyu' /* teclear para autocompletar */,
                                  ),
                                  hintStyle: FlutterFlowTheme.of(context)
                                      .bodySmall
                                      .override(
                            ...
                            fieldViewBuilder: (
                              ...
                              return TextFormField(
                                ...
                                decoration: InputDecoration(
                                  labelText:
                                      FFLocalizations.of(context).getText(
                                    'c88uvie5' /* Ingresar nombre nivel 3. JURIS... */,
                                  ),
                                  hintText: FFLocalizations.of(context).getText(
                                    'mzgoq55a' /* teclear para autocompletar */,
                                  ),
                                  hintStyle: FlutterFlowTheme.of(context)
                                      .bodySmall
                                      .override(
