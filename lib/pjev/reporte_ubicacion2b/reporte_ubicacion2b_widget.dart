...
import '/pjev/reporte_ubicacion3/reporte_ubicacion3_widget.dart';
import 'package:easy_debounce/easy_debounce.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:provider/provider.dart';
import 'reporte_ubicacion2b_model.dart';
export 'reporte_ubicacion2b_model.dart';

class ReporteUbicacion2bWidget extends StatefulWidget {
  const ReporteUbicacion2bWidget({super.key});

  @override
  State<ReporteUbicacion2bWidget> createState() =>
      _ReporteUbicacion2bWidgetState();
}

class _ReporteUbicacion2bWidgetState extends State<ReporteUbicacion2bWidget> {
  late ReporteUbicacion2bModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReporteUbicacion2bModel());
                    ...
                    children: [
                      Text(
                        FFLocalizations.of(context).getText(
                          'qxeaimaq' /* ANEXO 5. RESGUARDO TOTAL DE 
B... */
                          ,
                        ),
                            ...
                            fieldViewBuilder: (
                              ...
                              return TextFormField(
                                ...
                                decoration: InputDecoration(
                                  labelText:
                                      FFLocalizations.of(context).getText(
                                    'f4xaghkl' /* Depositario */,
                                  ),
                                  hintText: FFLocalizations.of(context).getText(
                                    '4yaa3u1i' /* Depositario */,
                                  ),
                            ...
                            fieldViewBuilder: (
                              ...
                              return TextFormField(
                                ...
                                decoration: InputDecoration(
                                  labelText:
                                      FFLocalizations.of(context).getText(
                                    'jh5s4tlh' /* Supervisor de Control de Inven... */,
                                  ),
                                  hintText: FFLocalizations.of(context).getText(
                                    '2355y1gt' /* Supervisor del área de Control... */,
                                  ),
                                  hintStyle: FlutterFlowTheme.of(context)
                                      .bodySmall
                                      .override(
                            ...
                            fieldViewBuilder: (
                              ...
                              return TextFormField(
                                ...
                                decoration: InputDecoration(
                                  labelText:
                                      FFLocalizations.of(context).getText(
                                    '4abcdzu2' /* ORGANIZACIÓN */,
                                  ),
                                  hintText: FFLocalizations.of(context).getText(
                                    '10bof69l' /* teclear para autocompletar */,
                                  ),
                                  hintStyle: FlutterFlowTheme.of(context)
                                      .bodySmall
                                      .override(
                            ...
                            fieldViewBuilder: (
                              ...
                              return TextFormField(
                                ...
                                decoration: InputDecoration(
                                  labelText:
                                      FFLocalizations.of(context).getText(
                                    'qiw9k8bx' /* Ingresar nombre nivel 2. DIREC... */,
                                  ),
                                  hintText: FFLocalizations.of(context).getText(
                                    'wti8oq17' /* teclear para autocompletar */,
                                  ),
                                  hintStyle: FlutterFlowTheme.of(context)
                                      .bodySmall
                                      .override(
                            ...
                            fieldViewBuilder: (
                              ...
                              return TextFormField(
                                ...
                                decoration: InputDecoration(
                                  labelText:
                                      FFLocalizations.of(context).getText(
                                    'hmv9lk86' /* Ingresar nombre nivel 3. JURIS... */,
                                  ),
                                  hintText: FFLocalizations.of(context).getText(
                                    'jv6fu4c7' /* teclear para autocompletar */,
                                  ),
                                  hintStyle: FlutterFlowTheme.of(context)
                                      .bodySmall
                                      .override(
