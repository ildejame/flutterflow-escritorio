...
import 'reporte_ubicacion3_model.dart';
export 'reporte_ubicacion3_model.dart';

class ReporteUbicacion3Widget extends StatefulWidget {
  const ReporteUbicacion3Widget({super.key});

  @override
  State<ReporteUbicacion3Widget> createState() =>
      _ReporteUbicacion3WidgetState();
}

class _ReporteUbicacion3WidgetState extends State<ReporteUbicacion3Widget> {
  late ReporteUbicacion3Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReporteUbicacion3Model());

    _model.nombreTextController ??=
        TextEditingController(text: FFAppState().depositario);
    _model.nombreFocusNode ??= FocusNode();

    _model.supervisorTextController ??=
        TextEditingController(text: FFAppState().revisor);
    _model.supervisorFocusNode ??= FocusNode();

    _model.nivel1TextController ??=
        TextEditingController(text: FFAppState().nivel1);
    _model.nivel1FocusNode ??= FocusNode();

    _model.nivel2TextController ??=
        TextEditingController(text: FFAppState().nivel2);
    _model.nivel2FocusNode ??= FocusNode();

    _model.nivel3TextController ??=
        TextEditingController(text: FFAppState().nivel3);
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              labelText: FFLocalizations.of(context).getText(
                                '27q66cm7' /* Depositario */,
                              ),
                              hintText: FFLocalizations.of(context).getText(
                                's3m57whe' /* Depositario */,
                              ),
                      ...
                      Expanded(
                        child: Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              5.0, 0.0, 5.0, 0.0),
                          child: TextFormField(
                            controller: _model.supervisorTextController,
                            focusNode: _model.supervisorFocusNode,
                            autofocus: true,
                            readOnly: true,
                            obscureText: false,
                            decoration: InputDecoration(
                              labelText: FFLocalizations.of(context).getText(
                                'yvullve3' /* Supervisor de Control de Inven... */,
                              ),
                              hintText: FFLocalizations.of(context).getText(
                                '6x8mmecw' /* Supervisor del área de Control... */,
                              ),
                              hintStyle: FlutterFlowTheme.of(context)
                                  .bodySmall
                                  .override(
                            ...
                            validator: _model.supervisorTextControllerValidator
                                .asValidator(context),
                          ),
                        ),
                      ),
                      ...
                      Expanded(
                        child: Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              5.0, 0.0, 5.0, 0.0),
                          child: TextFormField(
                            controller: _model.nivel1TextController,
                            focusNode: _model.nivel1FocusNode,
                            autofocus: false,
                            readOnly: true,
                            obscureText: false,
                            decoration: InputDecoration(
                              labelText: FFLocalizations.of(context).getText(
                                'by9pewqr' /* ORGANIZACIÓN */,
                              ),
                              hintText: FFLocalizations.of(context).getText(
                                '8qp0ey5q' /* teclear para autocompletar */,
                              ),
                              hintStyle: FlutterFlowTheme.of(context)
                                  .bodySmall
                                  .override(
                      ...
                      Expanded(
                        child: Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              5.0, 0.0, 5.0, 0.0),
                          child: TextFormField(
                            controller: _model.nivel2TextController,
                            focusNode: _model.nivel2FocusNode,
                            autofocus: false,
                            readOnly: true,
                            obscureText: false,
                            decoration: InputDecoration(
                              labelText: FFLocalizations.of(context).getText(
                                'jczvrdp0' /* Ingresar nombre nivel 2. DIREC... */,
                              ),
                              hintText: FFLocalizations.of(context).getText(
                                '5bsmoy9s' /* teclear para autocompletar */,
                              ),
                              hintStyle: FlutterFlowTheme.of(context)
                                  .bodySmall
                                  .override(
                      ...
                      Expanded(
                        child: Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              5.0, 0.0, 5.0, 0.0),
                          child: TextFormField(
                            controller: _model.nivel3TextController,
                            focusNode: _model.nivel3FocusNode,
                            autofocus: true,
                            readOnly: true,
                            obscureText: false,
                            decoration: InputDecoration(
                              labelText: FFLocalizations.of(context).getText(
                                'zgue0qo9' /* Ingresar nombre nivel 3. JURIS... */,
                              ),
                              hintText: FFLocalizations.of(context).getText(
                                'to3k0aft' /* teclear para autocompletar */,
                              ),
                              hintStyle: FlutterFlowTheme.of(context)
                                  .bodySmall
                                  .override(
                        ...
                        builder: (context, snapshot) {
                          ...
                          return FlutterFlowDropDown<String>(
                            controller: _model.distritoValueController ??=
                              ...
                              _model.distritoValue ??= FFAppState().distrito,
                            ),
                            ...
                            child: FutureBuilder<List<EmpleadospjevRecord>>(
                              future: queryEmpleadospjevRecordOnce(
                                queryBuilder: (empleadospjevRecord) =>
                                  ...
                                  'nombre',
                                  isEqualTo: valueOrDefault<String>(
                                    _model.supervisorTextController.text,
                                    'Sin definir',
                                  ),
                                ),
                                singleRecord: true,
                                  ...
                                  child:
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      return FFButtonWidget(
                                        onPressed: () async {
                                          if (!((_model.nombreTextController
                                                          .text !=
                                                      '') &&
                                              (_model.supervisorTextController
                                                          .text !=
                                          ...
                                          await actions.pdf8(
                                            ...
                                            _model
                                                .supervisorTextController.text,
                                            containerEmpleadospjevRecord!.cargo,
                                            valueOrDefault<String>(
                                              _model.nivel2TextController.text,
                                              'no definido',
                                            ),
                                            _model.distritoValue!,
                                            valueOrDefault<String>(
                                              _model.nivel3TextController.text,
                                              'PJEV',
                                            ),
                                          );
