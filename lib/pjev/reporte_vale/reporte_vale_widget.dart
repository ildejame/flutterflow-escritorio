...
import '/pjev/reporte_vale2/reporte_vale2_widget.dart';
import 'package:easy_debounce/easy_debounce.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:provider/provider.dart';
import 'reporte_vale_model.dart';
export 'reporte_vale_model.dart';

class ReporteValeWidget extends StatefulWidget {
  const ReporteValeWidget({super.key});

  @override
  State<ReporteValeWidget> createState() => _ReporteValeWidgetState();
}

class _ReporteValeWidgetState extends State<ReporteValeWidget> {
  late ReporteValeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReporteValeModel());
                      ...
                      Flexible(
                        child: Text(
                          FFLocalizations.of(context).getText(
                            'tarq0xkk' /* REPORTE DE VALE DE MOVIMIENTO */,
                          ),
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            labelText: FFLocalizations.of(context).getText(
                              'pz0kjwu1' /* Folio del vale correspondiente */,
                            ),
                            hintText: FFLocalizations.of(context).getText(
                              'g736xpb2' /* Folio del vale */,
                            ),
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              labelText: FFLocalizations.of(context).getText(
                                's9i1rq8r' /* Información adicional a inclui... */,
                              ),
                              hintText: FFLocalizations.of(context).getText(
                                'b47xr3uq' /* Información adicional */,
                              ),
                              hintStyle: GoogleFonts.poppins(
                                color: Color(0xFFFF0000),
                                fontWeight: FontWeight.w600,
                            ...
                            fieldViewBuilder: (
                              ...
                              return TextFormField(
                                ...
                                decoration: InputDecoration(
                                  labelText:
                                      FFLocalizations.of(context).getText(
                                    'yd03h6n8' /* Depositario */,
                                  ),
                                  hintText: FFLocalizations.of(context).getText(
                                    'eog8gvp5' /* Depositario */,
                                  ),
                            ...
                            fieldViewBuilder: (
                              ...
                              return TextFormField(
                                ...
                                decoration: InputDecoration(
                                  labelText:
                                      FFLocalizations.of(context).getText(
                                    'gwuzcb3v' /* Supervisor de Control de Inven... */,
                                  ),
                                  hintText: FFLocalizations.of(context).getText(
                                    'yiamynwq' /* Supervisor del área de Control... */,
                                  ),
                                  hintStyle: FlutterFlowTheme.of(context)
                                      .bodySmall
                                      .override(
                                  ...
                                  fillColor: FlutterFlowTheme.of(context)
                                      .primaryBtnText,
                                  suffixIcon: _model.supervisorTextController!
                                          .text.isNotEmpty
                                      ? InkWell(
                                          onTap: () async {
                                            _model.supervisorTextController
                        ...
                        child: Padding(
                          ...
                          child: Autocomplete<String>(
                            ...
                            optionsBuilder: (textEditingValue) {
                              ...
                              return FFAppState().sugerenciasN1.where((option) {
                                final lowercaseOption = option.toLowerCase();
                                return lowercaseOption.contains(
                                    textEditingValue.text.toLowerCase());
                              });
                            ...
                            fieldViewBuilder: (
                              ...
                              return TextFormField(
                                ...
                                decoration: InputDecoration(
                                  labelText:
                                      FFLocalizations.of(context).getText(
                                    'q5nvyif8' /* ORGANIZACIÓN */,
                                  ),
                                  hintText: FFLocalizations.of(context).getText(
                                    'bbqnwh5z' /* teclear para autocompletar */,
                                  ),
                                  hintStyle: FlutterFlowTheme.of(context)
                                      .bodySmall
                                      .override(
                        ...
                        child: Padding(
                          ...
                          child: Autocomplete<String>(
                            ...
                            optionsBuilder: (textEditingValue) {
                              ...
                              return FFAppState().sugerenciasN2.where((option) {
                                final lowercaseOption = option.toLowerCase();
                                return lowercaseOption.contains(
                                    textEditingValue.text.toLowerCase());
                              });
                            ...
                            fieldViewBuilder: (
                              ...
                              return TextFormField(
                                ...
                                decoration: InputDecoration(
                                  labelText:
                                      FFLocalizations.of(context).getText(
                                    'yhgvuii6' /* Ingresar nombre nivel 2. DIREC... */,
                                  ),
                                  hintText: FFLocalizations.of(context).getText(
                                    'i2486ifq' /* teclear para autocompletar */,
                                  ),
                                  hintStyle: FlutterFlowTheme.of(context)
                                      .bodySmall
                                      .override(
                                  ...
                                  fillColor: FlutterFlowTheme.of(context)
                                      .primaryBtnText,
                                  suffixIcon: _model
                                          .nivel2TextController!.text.isNotEmpty
                                      ? InkWell(
                                          onTap: () async {
                                            _model.nivel2TextController
                                                ?.clear();
                        ...
                        child: Padding(
                          ...
                          child: Autocomplete<String>(
                            ...
                            optionsBuilder: (textEditingValue) {
                              ...
                              return FFAppState().sugerenciasN3.where((option) {
                                final lowercaseOption = option.toLowerCase();
                                return lowercaseOption.contains(
                                    textEditingValue.text.toLowerCase());
                              });
                            ...
                            fieldViewBuilder: (
                              ...
                              return TextFormField(
                                ...
                                decoration: InputDecoration(
                                  labelText:
                                      FFLocalizations.of(context).getText(
                                    'g57c3ffm' /* Ingresar nombre nivel 3. JURIS... */,
                                  ),
                                  hintText: FFLocalizations.of(context).getText(
                                    '7mm1vnh4' /* teclear para autocompletar */,
                                  ),
                                  hintStyle: FlutterFlowTheme.of(context)
                                      .bodySmall
                                      .override(
                                  ...
                                  fillColor: FlutterFlowTheme.of(context)
                                      .primaryBtnText,
                                  suffixIcon: _model
                                          .nivel3TextController!.text.isNotEmpty
                                      ? InkWell(
                                          onTap: () async {
                                            _model.nivel3TextController
                                                ?.clear();
                        ...
                        child: Container(
                          ...
                          child: Builder(
                            builder: (context) => FFButtonWidget(
                              onPressed: () async {
                                if ((_model.nombreSelectedOption != null &&
                                        _model.nombreSelectedOption != '') &&
                                    (_model.supervisorSelectedOption != null &&
                                  ...
                                  FFAppState().revisor = valueOrDefault<String>(
                                    _model.supervisorSelectedOption,
                                    'No definido',
                                  );
                                  FFAppState().nivel1 =
                                      _model.nivel1SelectedOption!;
                                  FFAppState().nivel2 = valueOrDefault<String>(
                                    _model.nivel2SelectedOption,
                                    'No definido',
                                  );
                                  FFAppState().nivel3 =
                                      _model.nivel3SelectedOption!;
                                  FFAppState().distrito = _model.distritoValue!;
                                  FFAppState().foliovale =
                                      _model.folioTextController.text;
                                  FFAppState().comentariosvale =
                                      _model.atencionTextController.text;
                                  ...
                                  await showDialog(
                                    ...
                                    builder: (alertDialogContext) {
                                      return AlertDialog(
                                        title: Text('Seleccionar nombres'),
                                        content: Text(
