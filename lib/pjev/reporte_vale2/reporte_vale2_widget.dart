...
import 'reporte_vale2_model.dart';
export 'reporte_vale2_model.dart';

class ReporteVale2Widget extends StatefulWidget {
  const ReporteVale2Widget({super.key});

  @override
  State<ReporteVale2Widget> createState() => _ReporteVale2WidgetState();
}

class _ReporteVale2WidgetState extends State<ReporteVale2Widget> {
  late ReporteVale2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReporteVale2Model());
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              labelText: FFLocalizations.of(context).getText(
                                'aaboi42l' /* Depositario */,
                              ),
                              hintText: FFLocalizations.of(context).getText(
                                'w8hlrhrz' /* Depositario */,
                              ),
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              labelText: FFLocalizations.of(context).getText(
                                '9vtqmzhv' /* Supervisor de Control de Inven... */,
                              ),
                              hintText: FFLocalizations.of(context).getText(
                                'jtvrv6oj' /* Supervisor del área de Control... */,
                              ),
                              hintStyle: FlutterFlowTheme.of(context)
                                  .bodySmall
                                  .override(
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              labelText: FFLocalizations.of(context).getText(
                                'h6zg92yu' /* ORGANIZACIÓN */,
                              ),
                              hintText: FFLocalizations.of(context).getText(
                                'ifwiju3q' /* teclear para autocompletar */,
                              ),
                              hintStyle: FlutterFlowTheme.of(context)
                                  .bodySmall
                                  .override(
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              labelText: FFLocalizations.of(context).getText(
                                '2wxf3cn1' /* Ingresar nombre nivel 2. DIREC... */,
                              ),
                              hintText: FFLocalizations.of(context).getText(
                                'tnfbiqy1' /* teclear para autocompletar */,
                              ),
                              hintStyle: FlutterFlowTheme.of(context)
                                  .bodySmall
                                  .override(
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              labelText: FFLocalizations.of(context).getText(
                                'zrd7pfja' /* Ingresar nombre nivel 3. JURIS... */,
                              ),
                              hintText: FFLocalizations.of(context).getText(
                                '8eudm3gu' /* teclear para autocompletar */,
                              ),
                              hintStyle: FlutterFlowTheme.of(context)
                                  .bodySmall
                                  .override(
