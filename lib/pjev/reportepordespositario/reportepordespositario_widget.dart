...
import 'reportepordespositario_model.dart';
export 'reportepordespositario_model.dart';

class ReportepordespositarioWidget extends StatefulWidget {
  const ReportepordespositarioWidget({super.key});

  @override
  State<ReportepordespositarioWidget> createState() =>
      _ReportepordespositarioWidgetState();
}

class _ReportepordespositarioWidgetState
    extends State<ReportepordespositarioWidget> {
  late ReportepordespositarioModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReportepordespositarioModel());
                    ...
                    children: [
                      Text(
                        FFLocalizations.of(context).getText(
                          'pb158jpu' /* Escribir nombre de DEPOSITARIO... */,
                        ),
                            ...
                            fieldViewBuilder: (
                              ...
                              return TextFormField(
                                ...
                                decoration: InputDecoration(
                                  labelText:
                                      FFLocalizations.of(context).getText(
                                    'kl31xvig' /* Depositario */,
                                  ),
                                  hintText: FFLocalizations.of(context).getText(
                                    'kjlnfxuw' /* Depositario */,
                                  ),
                            ...
                            fieldViewBuilder: (
                              ...
                              return TextFormField(
                                ...
                                decoration: InputDecoration(
                                  labelText:
                                      FFLocalizations.of(context).getText(
                                    'lh4gvqmn' /* Supervisor de Control de Inven... */,
                                  ),
                                  hintText: FFLocalizations.of(context).getText(
                                    'oyqwwg18' /* Supervisor del área de Control... */,
                                  ),
                                  hintStyle: FlutterFlowTheme.of(context)
                                      .bodySmall
                                      .override(
                            ...
                            fieldViewBuilder: (
                              ...
                              return TextFormField(
                                ...
                                decoration: InputDecoration(
                                  labelText:
                                      FFLocalizations.of(context).getText(
                                    '4xeecmsn' /* Ingresar nombre nivel 2. Direc... */,
                                  ),
                                  hintText: FFLocalizations.of(context).getText(
                                    'vx2f4vmg' /* teclear para autocompletar */,
                                  ),
                                  hintStyle: FlutterFlowTheme.of(context)
                                      .bodySmall
                                      .override(
                                  ...
                                  child:
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      return FFButtonWidget(
                                        onPressed: () async {
                                          if (!((_model.nombreSelectedOption !=
                                                      null &&
                                                  _model.nombreSelectedOption !=
                                                      '') &&
                                              (_model.supervisorSelectedOption !=
