...
import 'reporteporresponsable_widget.dart' show ReporteporresponsableWidget;
import 'package:flutter/material.dart';

class ReporteporresponsableModel
    extends FlutterFlowModel<ReporteporresponsableWidget> {
  ///  State fields for stateful widgets in this component.

  // State field(s) for NombreResponsable widget.
  final nombreResponsableKey = GlobalKey();
  FocusNode? nombreResponsableFocusNode;
  TextEditingController? nombreResponsableTextController;
  String? nombreResponsableSelectedOption;
