...
import 'reporteporresponsable_model.dart';
export 'reporteporresponsable_model.dart';

class ReporteporresponsableWidget extends StatefulWidget {
  const ReporteporresponsableWidget({super.key});

  @override
  State<ReporteporresponsableWidget> createState() =>
      _ReporteporresponsableWidgetState();
}

class _ReporteporresponsableWidgetState
    extends State<ReporteporresponsableWidget> {
  late ReporteporresponsableModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReporteporresponsableModel());

    _model.nombreResponsableTextController ??= TextEditingController();
                      ...
                      children: [
                        Text(
                          FFLocalizations.of(context).getText(
                            'nsqw2oy7' /* Escribir nombre de RESPONSABLE... */,
                          ),
                            ...
                            child: Autocomplete<String>(
                              ...
                              optionsViewBuilder:
                                ...
                                return AutocompleteOptionsList(
                                  textFieldKey: _model.nombreResponsableKey,
                                  textController:
                              ...
                              onSelected: (String selection) {
                                safeSetState(() =>
                                    _model.nombreResponsableSelectedOption =
                                        selection);
                              ...
                              fieldViewBuilder: (
                                ...
                                return TextFormField(
                                  key: _model.nombreResponsableKey,
                                  ...
                                  decoration: InputDecoration(
                                    labelText:
                                        FFLocalizations.of(context).getText(
                                      '13ttj5bw' /* Responsable */,
                                    ),
                                    hintText:
                                        FFLocalizations.of(context).getText(
                                      'bkqy1a5f' /* Responsable */,
                                    ),
                        ...
                        Expanded(
                          child: Padding(
                            ...
                            child: Autocomplete<String>(
                              ...
                              onSelected: (String selection) {
                                safeSetState(() => _model
                                    .supervisorSelectedOption = selection);
                                FocusScope.of(context).unfocus();
                              },
                              fieldViewBuilder: (
                                context,
                                ...
                                return TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    labelText:
                                        FFLocalizations.of(context).getText(
                                      'sicx1sgg' /* Supervisor de Control de Inven... */,
                                    ),
                                    hintText:
                                        FFLocalizations.of(context).getText(
                                      'bdjuoycf' /* Supervisor del área de Control... */,
                                    ),
                                    hintStyle: FlutterFlowTheme.of(context)
                                        .bodySmall
                                        .override(
                              ...
                              fieldViewBuilder: (
                                ...
                                return TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    labelText:
                                        FFLocalizations.of(context).getText(
                                      'k1o5btvu' /* Ingresar nombre nivel 2. Direc... */,
                                    ),
                                    hintText:
                                        FFLocalizations.of(context).getText(
                                      'hxpw5sg7' /* teclear para autocompletar */,
                                    ),
                                    hintStyle: FlutterFlowTheme.of(context)
                                        .bodySmall
                                        .override(
                        ...
                        StreamBuilder<List<ListasPJEVRecord>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<ListasPJEVRecord>
                                distritoListasPJEVRecordList = snapshot.data!;
                                    ...
                                    child: FutureBuilder<
                                      ...
                                      future: queryBienesmueblesRecordOnce(
                                        queryBuilder: (bienesmueblesRecord) =>
                                          ...
                                          isEqualTo: valueOrDefault<String>(
                                            _model
                                                .nombreResponsableSelectedOption,
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        return FFButtonWidget(
                                          onPressed: () async {
                                            if (!((_model.nombreResponsableSelectedOption !=
                                                        null &&
                                                    _model.nombreResponsableSelectedOption !=
                                                        '') &&
                                                (_model.supervisorSelectedOption !=
