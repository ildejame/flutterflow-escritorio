...
import 'reporteporresponsable_copy_model.dart';
export 'reporteporresponsable_copy_model.dart';

class ReporteporresponsableCopyWidget extends StatefulWidget {
  const ReporteporresponsableCopyWidget({super.key});

  @override
  State<ReporteporresponsableCopyWidget> createState() =>
      _ReporteporresponsableCopyWidgetState();
}

class _ReporteporresponsableCopyWidgetState
    extends State<ReporteporresponsableCopyWidget> {
  late ReporteporresponsableCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReporteporresponsableCopyModel());
                    ...
                    children: [
                      Text(
                        FFLocalizations.of(context).getText(
                          'yj9vlves' /* Escribir nombre de RESPONSABLE... */,
                        ),
                            ...
                            fieldViewBuilder: (
                              ...
                              return TextFormField(
                                ...
                                decoration: InputDecoration(
                                  labelText:
                                      FFLocalizations.of(context).getText(
                                    'nrlhy8rb' /* Responsable */,
                                  ),
                                  hintText: FFLocalizations.of(context).getText(
                                    'rnroh7gm' /* Responsable  */,
                                  ),
                            ...
                            fieldViewBuilder: (
                              ...
                              return TextFormField(
                                ...
                                decoration: InputDecoration(
                                  labelText:
                                      FFLocalizations.of(context).getText(
                                    'b1dfe6lk' /* Supervisor de Control de Inven... */,
                                  ),
                                  hintText: FFLocalizations.of(context).getText(
                                    'xv57nvl6' /* Supervisor del área de Control... */,
                                  ),
                                  hintStyle: FlutterFlowTheme.of(context)
                                      .bodySmall
                                      .override(
                                              ...
                                              builder: (alertDialogContext) {
                                                return AlertDialog(
                                                  title: Text(
                                                      'Seleccionar nombres'),
                                                  content: Text(
                                                      'Responsable y supervisor deben estar seleccionados.'),
                                                  actions: [
                                                    TextButton(
                                                      onPressed: () =>
                                                          Navigator.pop(
