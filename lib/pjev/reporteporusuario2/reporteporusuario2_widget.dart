...
import 'reporteporusuario2_model.dart';
export 'reporteporusuario2_model.dart';

class Reporteporusuario2Widget extends StatefulWidget {
  const Reporteporusuario2Widget({super.key});

  @override
  State<Reporteporusuario2Widget> createState() =>
      _Reporteporusuario2WidgetState();
}

class _Reporteporusuario2WidgetState extends State<Reporteporusuario2Widget> {
  late Reporteporusuario2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Reporteporusuario2Model());
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              labelText: FFLocalizations.of(context).getText(
                                'lo0wr1vb' /* Depositario */,
                              ),
                              hintText: FFLocalizations.of(context).getText(
                                'qfxya8ej' /* Depositario */,
                              ),
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              labelText: FFLocalizations.of(context).getText(
                                'zllfefho' /* Supervisor de Control de Inven... */,
                              ),
                              hintText: FFLocalizations.of(context).getText(
                                'wxgrjbt0' /* Supervisor del área de Control... */,
                              ),
                              hintStyle: FlutterFlowTheme.of(context)
                                  .bodySmall
                                  .override(
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              labelText: FFLocalizations.of(context).getText(
                                'p2rkn97g' /* Ingresar nombre nivel 2. DIREC... */,
                              ),
                              hintText: FFLocalizations.of(context).getText(
                                'jxulpxk6' /* teclear para autocompletar */,
                              ),
                              hintStyle: FlutterFlowTheme.of(context)
                                  .bodySmall
                                  .override(
