...
import '/pjev/transferenciamasiva3/transferenciamasiva3_widget.dart';
import 'package:easy_debounce/easy_debounce.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:provider/provider.dart';
import 'transferenciamasiva_model.dart';
export 'transferenciamasiva_model.dart';

class TransferenciamasivaWidget extends StatefulWidget {
  const TransferenciamasivaWidget({super.key});

  @override
  State<TransferenciamasivaWidget> createState() =>
      _TransferenciamasivaWidgetState();
}

class _TransferenciamasivaWidgetState extends State<TransferenciamasivaWidget> {
  late TransferenciamasivaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TransferenciamasivaModel());
                            ...
                            fieldViewBuilder: (
                              ...
                              return TextFormField(
                                ...
                                decoration: InputDecoration(
                                  labelText:
                                      FFLocalizations.of(context).getText(
                                    '6944x66p' /* ORGANIZACIÓN */,
                                  ),
                                  hintText: FFLocalizations.of(context).getText(
                                    'y2w440by' /* teclear para autocompletar */,
                                  ),
                            ...
                            fieldViewBuilder: (
                              ...
                              return TextFormField(
                                ...
                                decoration: InputDecoration(
                                  labelText:
                                      FFLocalizations.of(context).getText(
                                    '6bxw7kz2' /* Ingresar nombre nivel 2. DIREC... */,
                                  ),
                                  hintText: FFLocalizations.of(context).getText(
                                    'f31zjbsm' /* teclear para autocompletar */,
                                  ),
                                  hintStyle: FlutterFlowTheme.of(context)
                                      .bodySmall
                                      .override(
                            ...
                            fieldViewBuilder: (
                              ...
                              return TextFormField(
                                ...
                                decoration: InputDecoration(
                                  labelText:
                                      FFLocalizations.of(context).getText(
                                    '7d953rv3' /* Ingresar nombre nivel 3. JURIS... */,
                                  ),
                                  hintText: FFLocalizations.of(context).getText(
                                    'zzhcutys' /* teclear para autocompletar */,
                                  ),
                                  hintStyle: FlutterFlowTheme.of(context)
                                      .bodySmall
                                      .override(
                                  ...
                                  builder: (dialogContext) {
                                    return Dialog(
                                      ...
                                      child: Container(
                                        height: 550.0,
                                        width: 350.0,
                                        child: Transferenciamasiva3Widget(),
                                      ),
                                    );
                                  },
                                );
