...
class UbicacionesWidget extends StatefulWidget {
  ...
  static String routePath = 'ubicaciones';
                                          ...
                                          children: [
                                            Padding(
                                              ...
                                              child: Text(
                                                FFLocalizations.of(context)
                                                    .getText(
                                                  'c4r7s9vy' /* Niveles de organización PJEV */,
                                                ),
                                                textAlign: TextAlign.center,
                                                style: FlutterFlowTheme.of(
                                                        context)
