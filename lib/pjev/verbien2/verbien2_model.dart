...
import '/index.dart';
import 'verbien2_widget.dart' show Verbien2Widget;
import 'package:flutter/material.dart';

class Verbien2Model extends FlutterFlowModel<Verbien2Widget> {
  ...
  FocusNode? seriemonitorFocusNode1;
  TextEditingController? seriemonitorTextController1;
  String? Function(BuildContext, String?)? seriemonitorTextController1Validator;
  ...
  // State field(s) for Seriemonitor widget.
  FocusNode? seriemonitorFocusNode2;
  TextEditingController? seriemonitorTextController2;
  String? Function(BuildContext, String?)? seriemonitorTextController2Validator;
  ...
  void dispose() {
    ...
    seriemonitorFocusNode1?.dispose();
    seriemonitorTextController1?.dispose();
    ...
    seriemonitorFocusNode2?.dispose();
    seriemonitorTextController2?.dispose();
